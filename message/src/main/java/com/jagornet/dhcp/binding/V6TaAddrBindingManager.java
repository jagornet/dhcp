...
public interface V6TaAddrBindingManager extends StaticBindingManager
{
	 ...
	 */
	public void init(String configfile) throws DhcpServerConfigException;
	...
	public Binding createSolicitBinding(DhcpLink clientLink, DhcpV6ClientIdOption clientIdOption, 
			DhcpV6IaTaOption iaTaOption, DhcpMessage requestMsg, byte state) throws InvocationTargetException, IllegalAccessException;
