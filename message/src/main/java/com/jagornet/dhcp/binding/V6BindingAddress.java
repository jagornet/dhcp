...
import com.jagornet.dhcp.config.DhcpV6OptionConfigObject;
...
{	
	 ...
	 */
	public V6BindingAddress(IaAddress iaAddr, DhcpConfigObject configObj) throws InvocationTargetException, IllegalAccessException {
