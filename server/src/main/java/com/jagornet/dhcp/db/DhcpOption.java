...
public class DhcpOption {
  ...
  protected byte[] value; // value includes 2 bytes for length to facilitate
                          // encode/decode
   ...
   * 
   * @param identityAssocId
   *          the new identity assoc id
   */
  ...
  public String toString() {
    return "DhcpOption: code=" + getCode() + " value=" + Util.toHexString(getValue());
  }
}
