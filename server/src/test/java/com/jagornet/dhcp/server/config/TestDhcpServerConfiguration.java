...
public class TestDhcpServerConfiguration extends TestCase
{
	...
	public void testSaveAndLoadConfig() throws Exception
	{
		...
		assertNotNull(config.getPolicies().getPolicyArray());
		assertEquals(1, config.getPolicies().getPolicyArray().length);
		assertEquals("sendRequestedOptionsOnly", config.getPolicies().getPolicyArray()[0].getName());
		assertEquals("true", config.getPolicies().getPolicyArray()[0].getValue());
	}
    ...
    public void testLinkMap() throws Exception
    {
        ...
        assertEquals(3, config.getV6MsgConfigOptions().getV6DnsServersOption().getIpAddressArray().length);
        assertEquals("3ffe::0001", config.getV6MsgConfigOptions().getV6DnsServersOption().getIpAddressArray()[0]);
        assertEquals("3ffe::0002", config.getV6MsgConfigOptions().getV6DnsServersOption().getIpAddressArray()[1]);
        assertEquals("3ffe::0003", config.getV6MsgConfigOptions().getV6DnsServersOption().getIpAddressArray()[2]);
        ...
        assertEquals(3, config.getV6MsgConfigOptions().getV6DomainSearchListOption().getDomainNameArray().length);
        assertEquals("foo.com.", config.getV6MsgConfigOptions().getV6DomainSearchListOption().getDomainNameArray()[0]);
        assertEquals("bar.com.", config.getV6MsgConfigOptions().getV6DomainSearchListOption().getDomainNameArray()[1]);
        assertEquals("yuk.com.", config.getV6MsgConfigOptions().getV6DomainSearchListOption().getDomainNameArray()[2]);
