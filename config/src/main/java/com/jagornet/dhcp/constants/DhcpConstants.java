...
/*
 *   This file DhcpConstants.java is part of Jagornet DHCP.
 *
 ...
 *
 */
package com.jagornet.dhcp.constants;
...
{
    private static final Logger log = LoggerFactory.getLogger(DhcpConstants.class);
	
	public static final String JAGORNET_DHCP_HOME = System.getProperty("jagornet.dhcp.home");
