...
import com.jagornet.dhcp.model.option.base.BaseDhcpOption;
import com.jagornet.dhcp.model.option.base.DhcpOption;
import com.jagornet.dhcp.model.option.generic.GenericOpaqueDataOption;
import com.jagornet.dhcp.model.option.generic.GenericOptionFactory;
    ...
    public DhcpV6VendorInfoOption(V6VendorInfoOption vendorInfoOption)
    {
    	...
    	if (vendorInfoOption != null) {
    		...
    		if (genericOptions != null) {
    			OptionDefType[] optdefs = genericOptions.getOptionDefArray();
    			if (optdefs != null) {
