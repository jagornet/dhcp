...
public abstract class BaseDomainNameListOption extends BaseDhcpOption implements DhcpComparableOption
{
	...
	protected final List<String> domainNameList = new LinkedList<String>();
	...
	public BaseDomainNameListOption(DomainNameListOptionType domainNameListOption)
	{
		...
		if (domainNameListOption != null) {
          setDomainNameList(domainNameListOption.getDomainNameArray());
		}
	}
	...
	public void setDomainNameList(String[] domainNames) {
    ...
    public boolean matches(OptionExpression expression)
    {
        ...
        if (exprOption != null) {
        	String[] exprDomainNames = exprOption.getDomainNameArray();
            Operator.Enum op = expression.getOperator();
            if (op.equals(Operator.EQUALS)) {
            	return domainNameList.equals(exprDomainNames);
            }
            else if (op.equals(Operator.CONTAINS)) {
            	return domainNameList.containsAll(Arrays.asList(exprDomainNames));
            }
            else {
