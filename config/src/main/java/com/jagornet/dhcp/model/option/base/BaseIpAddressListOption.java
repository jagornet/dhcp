...
public abstract class BaseIpAddressListOption extends BaseDhcpOption implements DhcpComparableOption
{
	...
	protected final List<String> ipAddressList = new LinkedList<>();
	...
	public BaseIpAddressListOption(IpAddressListOptionType ipAddressListOption)
	{
		...
		if (ipAddressListOption != null) {
            setIpAddressList(ipAddressListOption.getIpAddressArray());
		}
	}
	...
	public void setIpAddressList(String[] ipAddresses) {
		ipAddressList.clear();
    ...
    public boolean matches(OptionExpression expression)
    {
        ...
        if (exprOption != null) {
        	String[] exprIpAddresses = exprOption.getIpAddressArray();
            Operator.Enum op = expression.getOperator();
            if (op.equals(Operator.EQUALS)) {
            	return ipAddressList.equals(exprIpAddresses);
            }
            else if (op.equals(Operator.CONTAINS)) {
            	return ipAddressList.containsAll(Arrays.asList(exprIpAddresses));
            }
            else {
