...
public class TestDhcpDomainSearchListOption extends TestCase
{
    ...
    public void testDecode() throws Exception
    {
        ...
        DhcpV6DomainSearchListOption dslo = new DhcpV6DomainSearchListOption();
        dslo.decode(bb);
        assertEquals(2, dslo.getDomainNameList().length);
        String[] domainNames = dslo.getDomainNameList();
        assertEquals(domain1, domainNames[0]);
        assertEquals(domain2, domainNames[1]);
    }
