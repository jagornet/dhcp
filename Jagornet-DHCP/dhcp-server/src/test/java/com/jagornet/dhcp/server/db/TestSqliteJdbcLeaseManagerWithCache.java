...
public class TestSqliteJdbcLeaseManagerWithCache extends AbstractTestLeaseManager {

	private static Logger log = LoggerFactory.getLogger(TestSqliteJdbcLeaseManagerWithCache.class);
	
	@BeforeClass
	public static void oneTimeSetUp() throws Exception
	{
		File dbDir = new File("db/jdbc-sqlite");
		...
		initializeContext(DbSchemaManager.SCHEMATYPE_JDBC_SQLITE, BaseTestCase.DEFAULT_SCHEMA_VERSION);
