...
public class TestFileLeaseManagerWithCachePerformance extends AbstractTestLeaseManagerPerformance {

	private static Logger log = LoggerFactory.getLogger(TestFileLeaseManagerWithCachePerformance.class);
