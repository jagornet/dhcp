...
public class TestH2JdbcLeaseManagerWithCachePerformance extends AbstractTestLeaseManagerPerformance {

	private static Logger log = LoggerFactory.getLogger(TestH2JdbcLeaseManagerWithCachePerformance.class);
