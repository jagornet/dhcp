...
public class TestDerbyJdbcLeaseManagerWithCachePerformance extends AbstractTestLeaseManagerPerformance {

	private static Logger log = LoggerFactory.getLogger(TestDerbyJdbcLeaseManagerWithCachePerformance.class);
