...
public class TestDerbyJdbcLeaseManagerWithCache extends AbstractTestLeaseManager {

	private static Logger log = LoggerFactory.getLogger(TestDerbyJdbcLeaseManagerWithCache.class);
