...
public class FailoverChannelEncoder extends OneToOneEncoder
{
    
    /** The log. */
    private static Logger log = LoggerFactory.getLogger(FailoverChannelEncoder.class);
    ...
    {
        if (msg instanceof FailoverMessage) {
            FailoverMessage failoverMessage = (FailoverMessage) msg;
            ByteBuffer buf = failoverMessage.encode();
