...
public class FailoverChannelEncoder extends MessageToMessageEncoder<FailoverMessage>
{
	@Override
	protected void encode(ChannelHandlerContext ctx, FailoverMessage msg, List<Object> out) throws Exception {
