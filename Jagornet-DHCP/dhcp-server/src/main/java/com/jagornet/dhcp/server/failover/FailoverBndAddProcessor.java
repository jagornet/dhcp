...
public class FailoverBndAddProcessor extends BaseFailoverProcessor {
	
	private static Logger log = LoggerFactory.getLogger(FailoverBndAddProcessor.class);

	protected FailoverBndAddProcessor(FailoverMessage requestMsg) {
		super(requestMsg);
	}
	...
	public boolean process() {
		...
		if (binding != null) {
			//TODO: handle errors
			serverConfig.getIaMgr().createIA(binding);
