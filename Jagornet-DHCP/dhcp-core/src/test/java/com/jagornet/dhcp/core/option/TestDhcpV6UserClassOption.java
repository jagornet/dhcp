...
/*
 *   This file TestDhcpUserClassOption.java is part of Jagornet DHCP.
 *
...
/* TODO: remember what this test is supposed to do with empty ClientClassExpression?
    public void testMatches() throws Exception
    {
        ...
        assertFalse(duco.matches(new DhcpV6UserClassOption(expression.getV6UserClassOption()), Operator.EQUALS));
