...
import com.jagornet.dhcp.option.v6.DhcpV6BcmcsAddressesOption;
import com.jagornet.dhcp.option.v6.DhcpV6BcmcsDomainNamesOption;
import com.jagornet.dhcp.option.v6.DhcpV6DnsServersOption;
import com.jagornet.dhcp.option.v6.DhcpV6DomainSearchListOption;
import com.jagornet.dhcp.option.v6.DhcpV6GeoconfCivicOption;
import com.jagornet.dhcp.option.v6.DhcpV6InfoRefreshTimeOption;
import com.jagornet.dhcp.option.v6.DhcpV6LostServerDomainNameOption;
import com.jagornet.dhcp.option.v6.DhcpV6NewPosixTimezoneOption;
import com.jagornet.dhcp.option.v6.DhcpV6NewTzdbTimezoneOption;
import com.jagornet.dhcp.option.v6.DhcpV6NisDomainNameOption;
import com.jagornet.dhcp.option.v6.DhcpV6NisPlusDomainNameOption;
import com.jagornet.dhcp.option.v6.DhcpV6NisPlusServersOption;
import com.jagornet.dhcp.option.v6.DhcpV6NisServersOption;
import com.jagornet.dhcp.option.v6.DhcpV6PanaAgentAddressesOption;
import com.jagornet.dhcp.option.v6.DhcpV6PreferenceOption;
import com.jagornet.dhcp.option.v6.DhcpV6ServerUnicastOption;
import com.jagornet.dhcp.option.v6.DhcpV6SipServerAddressesOption;
import com.jagornet.dhcp.option.v6.DhcpV6SipServerDomainNamesOption;
import com.jagornet.dhcp.option.v6.DhcpV6SntpServersOption;
import com.jagornet.dhcp.option.v6.DhcpV6StatusCodeOption;
import com.jagornet.dhcp.option.v6.DhcpV6VendorInfoOption;
