...
{	
     ...
     * @param myBaseOpaqueData the my opaque
     * 
     * @return true, if successful
     */
    public static boolean matches(OptionExpression expression, BaseOpaqueData myBaseOpaqueData)
    {
        if (expression == null)
            return false;
        ...
        return matches(myBaseOpaqueData, opaqueOption.getOpaqueData(), op);
    }
    								...
    								OpaqueData thatOpaqueData, Operator op)
    {
        if (thatOpaqueData != null) {
            ...
            if ( (expAscii != null) && (myAscii != null) ) {
                ...
                byte[] expHex = thatOpaqueData.getHexValue();
                byte[] myHex = myBaseOpaqueData.getHex();
