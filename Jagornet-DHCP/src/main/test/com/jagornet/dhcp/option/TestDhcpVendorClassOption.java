...
/*
 *   This file TestDhcpVendorClassOption.java is part of Jagornet DHCP.
 *
...
public class TestDhcpVendorClassOption extends TestCase
{
    ...
    public void testMatches() throws Exception
    {
        ...
        assertFalse(dvco.matches(new DhcpV6VendorClassOption(expression.getV6VendorClassOption()), Operator.EQUALS));
